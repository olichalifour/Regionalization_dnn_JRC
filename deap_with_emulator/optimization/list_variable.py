...
# var_catch_attr = ['lat', 'lon', 'elv_mean', 'elv_std',
#        'gradient_mean', 'gradient_std', 'upArea_max', 'forest', 'irrigated',
#        'other', 'rice', 'sealed', 'water', 'land_use_main', 'cropcoef_mean',
#        'cropcoef_std', 'chanbnkf_mean', 'chanbw_mean', 'changrad_mean',
#        'chanlength_sum', 'chanman_mean', 'soildepth2', 'ksat2', 'lambda3',
#        'thetar3', 'thetas3', 'genua2', 'lambda2', 'thetar1', 'genua3',
#        'thetar2', 'soildepth1', 'ksat3', 'lambda1', 'thetas2', 'thetas1',
#        'genua1', 'soildepth3', 'ksat1',
#        'laiyrmean', 'laiyrmax', 'laiyrmin', 'elv_min', 'elv_max','no_reservoirs','storage_reservoirs', 'no_lakes', 'area_lakes']
...
#',
# 'lai01', 'lai02', 'lai03', 'lai04','lai05', 'lai06', 'lai07', 'lai08', 'lai09', 'lai10', 'lai11', 'lai12',
